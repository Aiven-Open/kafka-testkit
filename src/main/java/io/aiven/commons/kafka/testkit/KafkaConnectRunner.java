...
public final class KafkaConnectRunner {
   ...
   *
   * @param offsetFlushInterval The interval between flush calls to the offset topic.
   */
   ...
   *
   * @param connectorName the connector to pause.
   */
   ...
   *
   * @param connectorName the connector to resume.
   */
   ...
   *
   * <ul>
   *   <li>key converter = ByteArrayConverter
   *   <li>value converter = ByteArrayConverter
   *   <li>plugin discovery = HYBRID_WARN
   *   <li>offset flush interval = interval defined in this class constructor.
