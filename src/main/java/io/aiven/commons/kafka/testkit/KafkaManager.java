...
public final class KafkaManager {
   ...
   *
   * @param topic one or more topic names to create.
   */
   ...
   *
   * @param topics the list of topics to create.
   * @param partitions the number of partitions to use.
   * @param replicationFactor the replication factor to use.
   */
  public void createTopics(
      final List<String> topics, final int partitions, final short replicationFactor) {
   ...
   *
   * @param connectorName the connector to delete.
   */
   ...
   *
   * @param connectorName the connector to restart.
   */
